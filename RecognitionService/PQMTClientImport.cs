...
namespace PQMultiTouch
{
    ...
    {
        static int PQ_MT_CLIENT_VERSION     = 0x0103;
        static public int PQMT_DEFAULT_CLIENT_PORT = 21555;
        public enum EnumPQErrorType
        {
            ...
            PQMTE_EXCEPTION_FROM_CALLBACKFUNCTION = (0x31000003) // some exceptions thrown from the call back functions;
        }
        ...
        {
            public ushort   point_event;//Indicates current action or event of the touch point.
            public ushort   id;         //use id to distinguish different points on the screen.
            public int      x;          //the x-coordinate of the center position of the point.In pixels.
            public int      y;
            public ushort   dx;         //the x-width of the touch point.In pixels.
            public ushort   dy;
        }
        ...
        {
            public int screen_width;				//the physical touchable width of touch screen device, in millimeter
            public int screen_height;				//the physical touchable height of touch screen device, in millimeter
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 128)]
	        public string	serial_number;			//the serial number of touch screen device
        }
        ...
        /// <summary>
        /// getting the information of the device.
        /// </summary>
        ...
        static extern public int ConnectServer([In]string ip,int port);
        ...
        /// <returns></returns>
        [DllImport("PQMTClient.dll", CallingConvention = CallingConvention.Cdecl)]
        static extern public int SetRawDataResolution(int max_x,int max_y);
        ...
        /// </summary>
        /// <param name="pf_on_get_device_info"></param>
        /// <param name="call_back_object"></param>
        /// <returns></returns>
        [DllImport("PQMTClient.dll", CallingConvention = CallingConvention.Cdecl)]
        static extern public PFuncOnGetDeviceInfo SetOnGetDeviceInfo([In]PFuncOnGetDeviceInfo pf_on_get_device_info,IntPtr call_back_object);
